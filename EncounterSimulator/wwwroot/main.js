...
/* harmony import */ var _material_material_module__WEBPACK_IMPORTED_MODULE_43__ = __webpack_require__(/*! ./material/material.module */ "./src/app/material/material.module.ts");
/**
 * @fileoverview This file was generated by the Angular template compiler. Do not edit.
 *
 * @suppress {suspiciousCode,uselessCode,missingProperties,missingOverride,checkTypes}
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(http) {
        ...
        this.http.get('/api/values').subscribe(function (result) {
            for (var _i = 0, _a = result.json().characters; _i < _a.length; _i++) {
                var character = _a[_i];
